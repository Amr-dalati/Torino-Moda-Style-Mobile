...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductSize&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name));
}
...
@override
String toString() {
  return 'ProductSize(id: $id, code: $code, name: $name)';
}
...
class _ProductSize implements ProductSize {
  const _ProductSize({required this.id, required this.code, required this.name});
  factory _ProductSize.fromJson(Map<String, dynamic> json) => _$ProductSizeFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$ProductSizeToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductSize&&(identical(other.id, id) || other.id == id)&&(identical(other.code, code) || other.code == code)&&(identical(other.name, name) || other.name == name));
}
