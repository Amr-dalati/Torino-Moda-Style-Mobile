...
_UpdateCustomerAddressRequest _$UpdateCustomerAddressRequestFromJson(
...
Map<String, dynamic> _$UpdateCustomerAddressRequestToJson(
  _UpdateCustomerAddressRequest instance,
) => <String, dynamic>{
